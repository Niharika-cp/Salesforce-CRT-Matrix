...
export default class ScheduledBranchPopupCompo extends LightningElement {
  ...
  @api branchTobe
     ...
     //event
     scheduleCloseJobPopupHandler(){ 
          const myEvent = new CustomEvent("schedulebranchpopupevent",{detail:false});
