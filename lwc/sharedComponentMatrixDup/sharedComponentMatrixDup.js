...
import matrix from '@salesforce/apex/SharedComponentMatrixClassDup.matrix';
import searchKey from '@salesforce/apex/SharedComponentMatrixClassDup.searchKey';
...
export default class SharedComponentMatrixDup extends NavigationMixin(LightningElement) {
    wrappersList = [];
